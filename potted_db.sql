...
create table t_product_option_stock (
	...
	poi_id varchar(10) not null,			-- 옵션 대분류 코드
...
insert into t_product_option_stock values ('1-1', '1-1.직접 분갈이 (분갈이+난석+깔망)', '1.분갈이', 'CCaa201', 50, 0, 'y');
insert into t_product_option_stock values ('1-2', '1-2.분갈이 요청(분갈이+난석+분갈이)', '1.분갈이', 'CCaa201', 100, 0, 'y');
insert into t_product_option_stock values ('2-1', '2-1.아트스톤 화분', '2.화분', 'CCaa201', 20, 0, 'y');
insert into t_product_option_stock values ('2-2', '2-2.도자기 화분', '2.화분', 'CCaa201', 10, 0, 'y');
insert into t_product_option_stock values ('2-3', '2-3.유약분', '2.화분', 'CCaa201', 230, 0, 'y');
insert into t_product_option_stock values ('2-4', '2-4.토분', '2.화분', 'CCaa201', 70, 0, 'y');
insert into t_product_option_stock values ('3-1', '3-1.마사토', '3.마감돌', 'CCaa201', 500, 0, 'y');
insert into t_product_option_stock values ('3-2', '3-2.화산석', '3.마감돌', 'CCaa201', 150, 0, 'y');
insert into t_product_option_stock values ('3-3', '3-3:자갈', '3.마감돌', 'CCaa201', 200, 0, 'y');
