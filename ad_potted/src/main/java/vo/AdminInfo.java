...
public class AdminInfo {
	...
	public AdminInfo(int ai_idx, String ai_id, String ai_pw, String ai_name, String ai_use, String ai_date) {
		this.ai_idx = ai_idx;	this.ai_id = ai_id;	this.ai_pw = ai_pw;	this.ai_name = ai_name;	this.ai_use = ai_use;	this.ai_date = ai_date;
	}
