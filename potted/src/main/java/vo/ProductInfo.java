...
public class ProductInfo {
	...
	public ProductInfo(String pi_id, String pcb_id, String pcs_id, String pi_name, String pi_status, String pi_img1,
			...
			int pi_admin, double pi_dc, String pcb_name, String pcs_name, int ps_stock) {
		...
		this.pi_dc = pi_dc;			this.pcb_name = pcb_name;		this.pcs_name = pcs_name;	this.ps_stock = ps_stock;
	}
