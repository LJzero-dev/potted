...
public class CartDao {
	...
	public int cartInsert(OrderCart oc) {
		String sql = "insert into t_order_cart (mi_id, pi_id, oc_option, oc_cnt, oc_price, first_cnt) values ('" + oc.getMi_id() + "', '" + oc.getPi_id() + "', '" + oc.getOc_option() + "', " + oc.getOc_cnt() + ", " + oc.getOc_price() + ", " + oc.getFirst_cnt() + ")";
	...
	public List<OrderCart> getOrderCart(String miid) {
		String sql = "select a.mi_id, a.pi_id, a.oc_date, a.oc_option, a.oc_cnt, a.oc_price, a.first_cnt, a.oc_idx, b.pi_img1, b.pi_name, b.pi_price, b.pi_dc, b.pi_stock from t_order_cart a, t_product_info b where a.pi_id = b.pi_id and a.mi_id = '" + miid + "' ";
		List<OrderCart> orderCart = jdbc.query(sql, (ResultSet rs, int rowNum) -> {
			...
			oc.setFirst_cnt(rs.getInt("first_cnt"));
			return oc;
