...
.ctgrb {margin-right:10px; padding: 6px 20px; font-size: 20px; color: #6E6E6E; cursor: pointer; text-align: center; height:30px;border:1.5px solid  #6E6E6E; float:left; margin-bottom:10px; background: white; border-radius: 20px;  }
.ctgrb:hover { font-color: #0B9649; border-color: #0B9649; color: #0B9649; }
.selected { font-color: #0B9649; color: #0B9649; border:2px solid #0B9649; }
</style>
...
<table width="800">
	<tr>
		<td width="150" valign="top">
				<div style="width:970px;">
					...
					<input placeholder="식물을 검색해 주세요." name="serch" value="${serch}" style="width:800px; border:0; font-size:13pt;" />
	...
	<table width="100%" cellpadding="15" cellspacing="0" >
		...
		<tr v-if="arrObjLength == 1" >
			<td width="10%" align="left">	
				<a :href="url + arrObj.plantPilbkNo">
					<div style="display:inline-block;vertical-align:top;">
						<img :src="arrObj.imgUrl" style="width:180px; height:180px; border:0px; margin-right:20px;" />
					</div>
					<div style="display:inline-block;">
						<strong style="font-size:20px;">{{arrObj.plantGnrlNm}}</strong>&nbsp;&nbsp;도감번호 : {{arrObj.plantPilbkNo}}
						<br /><br />
						[비추천명] : {{arrObj.notRcmmGnrlNm}}<br /><br />
						{{arrObj.familyKorNm + "  " + arrObj.genusKorNm}}<br /><br />
						{{arrObj.familyNm + "  " + arrObj.genusNm}}<br /><br />
						학명 : {{arrObj.plantSpecsScnm}}
					</div>
					<hr :style="hrs" />	
				</a>
			</td>
...
new Vue({
	el : "#plantList",
	data : {
		url : "plntIlstrInfo?plantPilbkNo=",
		arrObjLength : ${plantListJson}.response.body.totalCount,
