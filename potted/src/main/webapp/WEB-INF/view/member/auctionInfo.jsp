...
ArrayList<OrderInfo> auctionOrderList = (ArrayList<OrderInfo>)request.getAttribute("auctionOrderList");
%>
...
String status = "";
String oilnk = "";
for (int i = 0 ; i < auctionOrderList.size() ; i++) {
	OrderInfo oi = auctionOrderList.get(i);
