...
<tr>
<td><img src="/potted/resources/images/myPlant/tree4.png" onclick="select('초급');" style="width:200px; height:200px; cursor:pointer;" /></td>
...
<td><img src="/potted/resources/images/myPlant/tree1.png" onclick="select('고급');" style="width:200px; height:200px; cursor:pointer;" /></td>
